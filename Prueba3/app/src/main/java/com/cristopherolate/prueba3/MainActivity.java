package com.cristopherolate.prueba3;
        ...
        try {
            mqttAndroidClient.connect(mqttConnectOptions, null, new IMqttActionListener() {
                ...
                public void onSuccess(IMqttToken asyncActionToken) {
                    ...
                    try {
                        mqttAndroidClient.subscribe("sensor/sensoresolate",2);
                        Toast.makeText(MainActivity.this, "Test de cone", Toast.LENGTH_SHORT).show();
